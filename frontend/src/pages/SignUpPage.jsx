...
import { Eye, EyeOff, Loader2, Lock, Mail, MessageSquare, User, Sparkles, Crown } from "lucide-react";
            ...
            <div className="flex flex-col items-center gap-4 group">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <span className="text-sm font-medium text-accent">Join Premium</span>
                  <Crown className="w-4 h-4 text-accent" />
                </div>
                <p className="text-base-content/60">Get started with your NexusChat account</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 border border-white/20 shadow-premium">
            ...
            <div className="text-center mt-6">
              <p className="text-base-content/60">
                ...
                <Link to="/login" className="text-primary font-semibold hover:underline transition-all duration-300">
                  Sign in
                </Link>
              </p>
            </div>
